...
VOI_SHAPE = (1000,1000,250)#(500, 500, 250)
VOI_OFFS  =  ((4,996),(4,996),(4,246))#((4,496),(4,496),(4,246))
...
"""
cvt_allParams = [
    [0.02, 1, 2, 1, 0, 0, 1000, -0.3],
    [0.02, 1, 2, 1, 0, 0, 1000, -0.3],
    [0.02, 1, 2, 1, 0, 0, 1000, -0.3],
    [0.02, 1, 1, 1, 0, 0, 0, -0.3],
    [0.02, 1, 1, 1, 0, 0, 0, -0.4],
    [0.02, 1, 1, 1, 0, 0, 300, -0.3],
    [0.02, 1, 1, 1, 0, 0, 0, -0.3],
    [0.02, 1, 2, 1, 0, 0, 2000, -0.3],
    [0.02, 1, 2, 1, 0, 0, 3000, -0.3],
    [0.02, 1, 1, 1, 0, 0, 1000, -0.3],
]
