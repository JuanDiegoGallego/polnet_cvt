...
cvt_allParams = [
    [0.02, 1, 1, 1, 0, 0, 0, -0.31],
    [0.02, 1, 1, 1, 0, 0, 400, -0.3],
    [0.02, 1, 1, 1, 0, 0, 600, -0.3],
    [0.02, 1, 1, 1, 0, 0, 800, -0.3],
    [0.02, 1, 1, 1, 0, 0, 1000, -0.3],
    [0.02, 1, 1, 1, 0, 0, -200, -0.3],
    [0.02, 1, 1, 1, 0, 0, -400, -0.3],
    [0.02, 1, 1, 1, 0, 0, 0, -0.31],
]
...
if len(sys.argv) < 2:
    print("Error: Missing required argument for tomod_id.")
    sys.exit(1)
try:
    tomod_id = int(sys.argv[1])
except ValueError:
    print("Error: tomod_id must be an integer.")
    sys.exit(1)
...
OUT_DIR = os.path.realpath(
    ROOT_PATH + '/data_generated/all_v11/Tomo0' + str(tomod_id)
